...
/*EJERCICIO INTEGRADOR DE POO II
Conceptos aplicados
...
public class Entidad_fabrica {
    
    private ArrayList <Entidad_sucursal> sucursales;
    
    
    public Entidad_fabrica() {
        
        this.sucursales = new ArrayList();
    }
    
    public void guardarSucursales(Entidad_sucursal sucu){
        sucursales.add(sucu);
        
    }
    public void mostrarSucursales(){
        
        for (Entidad_sucursal sucursales : sucursales) {
            System.out.println("las sucursales son: " +sucursales);
        }
     }
   }
